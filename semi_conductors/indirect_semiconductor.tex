...
\begin{tikzpicture}
    ...
    \draw[color=green, ->, opacity=0.5] (0,2) -- (0,3);
    \draw[color=green, dashed, opacity=0.5] (0,3) -- (1,3);
    \draw[color=blue, ->, opacity=0.5] (0,2) -- (1,2);
    \draw[color=blue, dashed, opacity=0.5] (1,2) -- (1,3);

    \coordinate (LO) at (-2,5);
    \coordinate (CO) at (1,3);
    \coordinate (RO) at (4,5);
